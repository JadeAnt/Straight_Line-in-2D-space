class StraightLine {
  ...
  public:
    ...
    void horizontalShift(double shiftBy); // shifts the line to the left or right, by changing the x intercept

    void verticalShift(double shiftBy);//shifts the line up or down using the y intercept
